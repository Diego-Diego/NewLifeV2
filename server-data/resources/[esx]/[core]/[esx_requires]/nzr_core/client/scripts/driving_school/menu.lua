code_menu = false
local menu_code = RageUI.CreateMenu("", "Options disponibles :", nil, nil, "banner", "banner2")
        ...
        CreateThread(function()
            while code_menu do
                ...
                RageUI.IsVisible(menu_code, function()
                    ...
                    RageUI.Separator("~r~↓↓~w~  Auto-école  ~r~↓↓~w~")
                    RageUI.Line({})
...
examen_menu = false
local menu_examen = RageUI.CreateMenu("", "Examen :", nil, nil, "banner", "banner2")
local menu_examen_1 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_2 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_3 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_4 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_5 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_6 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_7 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_8 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_9 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_10 = RageUI.CreateSubMenu(menu_examen, "", "Réponses disponibles :", nil, nil, "banner", "banner2")
local menu_examen_final = RageUI.CreateSubMenu(menu_examen, "", "Résultat du code :", nil, nil, "banner", "banner2")
