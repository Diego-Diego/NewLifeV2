        ...
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if Enabled == true or Enabled == nil then
                    ...
                    RenderText(Label, CurrentMenu.X + SettingsButton.Text.X + 27, CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, SettingsButton.Text.Scale, 163, 159, 148, 255)
                ...
                if Enabled == true then
                    ...
                    elseif Selected then
                        if(Actions.onActive ~= nil) then
                            Actions.onActive(Index, Items[Index])
                        end 
                    end
                end
            end
