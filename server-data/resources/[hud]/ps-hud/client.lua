...
-- Keymapping Shi
RegisterKeyMapping('menu', 'Ouvrir le menu', 'keyboard', Config.OpenMenu)
RegisterKeyMapping('/engine', 'Allumer/éteindre le moteur', 'keyboard', Config.StartEngine)
RegisterKeyMapping('/toggleseatbelt', 'Mettre/enlever la ceinture', 'keyboard', Config.ToggleSeatbelt)
...
RegisterNetEvent("hud:close")
AddEventHandler("hud:close", function(show)
    SendNUIMessage({
        action = 'hudtick',
        topic = 'display',
        show = show,
